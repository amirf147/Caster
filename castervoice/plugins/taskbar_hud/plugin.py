...
from castervoice.plugins.taskbar_hud.bridge import TaskbarHudBridgeClient
...
class TaskbarHudPlugin(PluginBase):
    ...
    def _on_adce_context_changed(self, process_name="", window_title="", semantic_zone="", active_file="", is_connected=True):
